      ...
      <div className="ds-container">
        ...
        <div className="pt-8 border-t border-white/10 text-[11px] text-white/50 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 text-center sm:text-left">
          <div className="flex flex-col gap-1">
            ...
            <p>Designed and developed by <a href="https://sivragp.com" target="_blank" rel="noopener noreferrer" className="font-medium text-[#ae9166] hover:text-[#c4a373] transition-colors">SIVRA Growth Partner</a></p>
          </div>
